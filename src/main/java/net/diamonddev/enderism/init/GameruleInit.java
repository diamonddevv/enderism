...
public class GameruleInit implements Registerable {
    ...
    public static GameRules.Key<GameRules.BooleanRule> VILLAGERS_TRADE_UPTHRUST;
    ...
    public void register() {
        ...
        VILLAGERS_TRADE_UPTHRUST = GameRuleRegistry.register("villagersTradeUpthrust", GameRules.Category.PLAYER, GameRuleFactory.createBooleanRule(false));
    }
}
