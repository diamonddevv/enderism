...
public class BlockInit implements Registerable {
    ...
    public static FibrousChorusBlock FIBROUS_CHORUS = new FibrousChorusBlock(1.5f, FabricBlockSettings.of(Material.ORGANIC_PRODUCT).hardness(2.0f).strength(2.0f));
