...
public class PotionInit implements Registerable {
    ...
    public static Potion VOID_RECALL_SHORT = new Potion(new StatusEffectInstance(EffectInit.VOID_RECALL, 3000));
    public static Potion VOID_RECALL_LONG = new Potion(new StatusEffectInstance(EffectInit.VOID_RECALL, 6000));
